...
- In the folder [task9_3](task9_3), you have [manifest definitions](./task9_3/manifests.yaml) for two deployments and one service. Apply them. 
...
```
However, it should not work for:
